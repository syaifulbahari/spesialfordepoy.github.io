...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo depoy sayang", "Aku ada pertanyaan nih buat kamu yangg", "question").then(function () {
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        Swal.fire('yahhh , emang ga kangen sama calon pacar sendiri', '', 'error').then(function () {
